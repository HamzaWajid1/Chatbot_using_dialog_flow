...
def add_to_order(parameters: dict, session_id: str):
    ...
    if len(food_items) != len(quantities):
        ...
        output_str = generic_helper.get_str_from_food_dict(inProgress_order[session_id])
        fulfillment_text = f"So far you have: {output_str} . Do you need anything else?"
...
def complete_order(parameters: dict, session_id: str):
    if session_id not in inProgress_order:
        fulfillment_text = "I'm having a trouble finding your order . Sorry! Can you please place a new order?"
    else:
